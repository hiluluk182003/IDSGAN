...
class TestScores(unittest.TestCase):
    ...
    expected_detection_rate = binary_tp / (binary_tp + binary_fn)                                       # 4 / 5

    def test_binary_class_scores(self):
        accuracy, f1, precision, recall, detection_rate = get_binary_class_scores(self.binary_labels, self.binary_predictions)
        ...
        self.assertAlmostEqual(detection_rate, self.expected_detection_rate)
